...
import { getAdminList } from '../services/RentalService';
...
export class EquipmentScreen extends Component {
  ...
  fetchData = () => {
    getAdminList().then(res => {
      console.log("EQUIPMENT", res.produktDtoList);
      this.setState({
        data: res.produktDtoList
      });
    })
  ...
  renderImage(item) {
    ...
    return <Image style={{ width: '100%', height: '100%', resizeMode: 'contain' }} source={require('../images/camera.png')} />
